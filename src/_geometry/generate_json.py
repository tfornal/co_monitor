    ...
    "dispersive element": {
        "element": {
            ...
            "C": {
                ...
                "vertex": {
                    "A": [-5546.404, 6821.796, -30.959],
                    "B": [-5566.607, 6898.993, -25.254],
                    "C": [-5567.611, 6900.203, -45.192],
                    "D": [-5547.408, 6823.007, -50.90],
                },
            },
            "N": {
                "AOI": 29.71,
                ...
                "vertex": {
                    "A": [-5549.23, 6822.393, -568.999],
                    "B": [-5564.785, 6900.667, -574.57],
                    "C": [-5563.773, 6899.448, -594.513],
                    "D": [-5548.218, 6821.173, -588.936],
                },
            },
            "O": {
                "AOI": 46.86,
...
with open("src/_geometry/coordinates.json", "w") as outfile:
