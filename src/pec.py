...
class PEC2:
    ...
    def interpolation(self):
        ...
        # interpolated_pec = interpolated_pec.reshape(-1, 3)
        interpolated_pec = interpolated_pec.reshape(-1, len(te_new), 3)
        return interpolated_pec

    def plot_pec_data(self):
        print(self.interpolated_pec.shape)
        # ne, te, pec = self.interpolated_pec[0]
...
if __name__ == "__main__":
    ...
    for transition in transitions_list:
        pec = PEC2("C", 33.7, transition, interp_step=60, plot=True)
